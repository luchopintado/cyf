                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-nombre">Nombre:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-nombre" name="obra_nombre" >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-plazo">Plazo:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-plazo" name="obra_plazo" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-cliente">Cliente:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-cliente" name="obra_cliente" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-participacion">Participacion:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-participacion" name="obra_participacion" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-fechareg">Fechareg:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-fechareg" name="obra_fechareg"  required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-tipo">Tipo:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-tipo" name="obra_tipo"  required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-periodo">Periodo:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-periodo" name="obra_periodo" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-obra-user">User:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-obra-user" name="obra_user"  required>
                                    </div>
                                </div>
            ...
            $(function() {
                ...
                var dt_options = {
                    ...
                    "aoColumns": [
                        ...
                        {"mDataProp": "obra_nombre", "bSearchable": true},
                        {"mDataProp": "obra_descripcion", "bSearchable": true},
                        {"mDataProp": "obra_plazo", "bSearchable": true},
                        {"mDataProp": "obra_cliente", "bSearchable": true},
                        {"mDataProp": "obra_participacion", "bSearchable": true},
                        {"mDataProp": "obra_fechareg", "bSearchable": true, "bVisible": false},
                        {"mDataProp": "obra_tipo", "bSearchable": true},
                        {"mDataProp": "obra_periodo", "bSearchable": true},
                    ...
                    "aoColumnDefs": [
                        {
                            "fnRender": function ( oObj ) {
                                var tipo = oObj.aData["obra_tipo"] * 1 === 1 ? "Construcción" : "Ingeniería";
                                return tipo;
                            },
                            "aTargets": [7]
                        }
                        ...
                        $.post(
                            ...
                            function(data){
                                ...
                                if(data.obra){
                                    ...
                                    $("#txt-obra-nombre").val(x.obra_nombre);
                                    $("#txt-obra-descripcion").val(x.obra_descripcion);
                                    $("#txt-obra-plazo").val(x.obra_plazo);
                                    $("#txt-obra-cliente").val(x.obra_cliente);
                                    $("#txt-obra-participacion").val(x.obra_participacion);
                                    $("#txt-obra-fechareg").val(x.obra_fechareg);
                                    $("#txt-obra-tipo").val(x.obra_tipo);
                                    $("#txt-obra-periodo").val(x.obra_periodo);
                                    $("#txt-obra-user").val(x.obra_user);
