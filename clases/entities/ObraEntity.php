...
class ObraEntity extends EntityBase implements DBOCrud{
  ...
  public function insert() {
    try {
      ...
      $stmt->bindParam(':obra_plazo', $this->obra_plazo, PDO::PARAM_STR);
      $stmt->bindParam(':obra_cliente', $this->obra_cliente, PDO::PARAM_STR);
      $stmt->bindParam(':obra_participacion', $this->obra_participacion, PDO::PARAM_STR);
      $stmt->bindParam(':obra_fechareg', $this->obra_fechareg, PDO::PARAM_STR);
      $stmt->bindParam(':obra_tipo', $this->obra_tipo, PDO::PARAM_INT);
      $stmt->bindParam(':obra_periodo', $this->obra_periodo, PDO::PARAM_STR);
  ...
  public function update() {
    try {
      ...
      $stmt = $pdo->prepare(
          ...
          obra_participacion=:obra_participacion,
          obra_fechareg=:obra_fechareg,
          obra_tipo=:obra_tipo,
          obra_periodo=:obra_periodo,
