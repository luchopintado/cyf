                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                         <h4 class="modal-title" id="modal-nuevo-article-label">Registrar nueva Información</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-article-image">Imagen(290x380):</label>
                                    <div class="col-sm-8">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#btn-editar").click(function(){
                    var anSelected = fnGetSelected( $dt_tabla_article );
                    if (anSelected.length !== 0) {
                        $("#modal-nuevo-article-label").html("Actualizar");
                        var id = $dt_tabla_article.fnGetData(anSelected[0], 0);
                        ...
                        function(data){
                            if($("#hdn-option").val() == "actualizar_article"){
                                ...
                                if(data.article_id){
                                    ...
                                    msg_error("Error al registrar registro.");
                                }
                            }
                        },
                        'json'
