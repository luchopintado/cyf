                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-cliente-fechareg">Fechareg:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-cliente-fechareg" name="cliente_fechareg"  required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="txt-cliente-user">User:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="txt-cliente-user" name="cliente_user" >
                                    </div>
                                </div>
            ...
            $(function() {
                ...
                var dt_options = {
                    ...
                    "aoColumns": [
                        ...
                        {"mDataProp": "cliente_fechareg", "bSearchable": true, "bVisible": false},
                        {"mDataProp": "cliente_user", "bSearchable": true, "bVisible": false},
                    ],
                    "bServerSide": true,
