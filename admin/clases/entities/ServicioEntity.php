...
class ServicioEntity extends EntityBase implements DBOCrud{
  ...
  public function insert() {
    try {
      ...
      $stmt->bindParam(':servicio_img1', $this->servicio_img1, PDO::PARAM_STR);
      $stmt->bindParam(':servicio_img2', $this->servicio_img2, PDO::PARAM_STR);
  ...
  public function update() {
    try {
      ...
      $stmt = $pdo->prepare(
          ...
          servicio_img1=:servicio_img1,
          servicio_img2=:servicio_img2,
